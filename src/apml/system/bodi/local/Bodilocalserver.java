...
public class Bodilocalserver extends Thread
{
	...
	{
		if (Bodi.hascontextat("//system/bodi"))
			throw new SecurityException("//bodi/connect");
	...
	private static Bodiresponse _processrequest(String input, Bodiresponse response)
	{
		...
		if (response.result != null && response.result.equalsIgnoreCase("failure"))
			throw new SecurityException("//bodi/connect");
		...
		{
			case "//close":
				return Bodilocalserver._close(input, response);

			case "//handshake":
				return Bodilocalserver._handshake(input, response);

			case "//list":
				return Bodilocalserver._list(input, response);

			case "//open":
				return Bodilocalserver._open(input, response);

			case "//pull":
				return Bodilocalserver._pull(input, response);

			case "//put":
				return Bodilocalserver._put(input, response);

			case "//trade":
				return Bodilocalserver._trade(input, response);
	...
	private Bodiresponse processrequest(String input, Bodiresponse response)
	{
		...
		{
			case "//close":
				return this.close(input, response);

			case "//handshake":
				return this.handshake(input, response);

			case "//list":
				return this.list(input, response);

			case "//open":
				return this.open(input, response);

			case "//pull":
				return this.pull(input, response);

			case "//put":
				return this.put(input, response);

			case "//trade":
				return this.trade(input, response);
