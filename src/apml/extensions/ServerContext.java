...
{   
    ...
    {
        if(server==null || protocol==null || servercontext==null) throw new SecurityException("//bodi/connect");                 
    ...
    {                        
        if(server==null || networkcontext==null /* || resourcecontext==null */) throw new SecurityException("//bodi/connect");  
    ...
    {
        if( resourceserver==null || protocol==null || input==null || networkcontext==null || resourcecontext==null) throw new SecurityException("//bodi/connect");
