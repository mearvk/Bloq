...
public class ResourceContext
{
	...
	{
		if (connectioncontext.resourcecontext == null)
			return false;

		if (connectioncontext.resourcecontext.ttl <= 0)
			return false;

		if (this.server.isvalidsession(connectioncontext.resourcecontext) == null)
			return false;
