...
import apml.extensions.servers.threading.*;
 ...
 * @author Max Rupplin
 */
public abstract class AbstractBaseServer extends Thread
{
     ...
     * @param port 
     */
    public AbstractBaseServer(String host, Integer port)
    {
     ...
     * @param port 
     */
    public AbstractBaseServer(Integer port)
    {
