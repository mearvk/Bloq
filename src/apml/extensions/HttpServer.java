...
{      
    ...
    public void processprotocol(ServerContext connectioncontext) throws Exception
    {
        ...
        switch(protocoltoken)
        {
            ...
            default: throw new Exception("//bodi/connect");            
        }
    }
    ...
    public void processrequest(ServerContext connectioncontext) throws Exception
    {
        ...
        switch(protocoltoken)
        {
            case "GET": this.processGET(connectioncontext); break;
            
            case "HEAD": this.processHEAD(connectioncontext); break;
            
            case "POST": this.processPOST(connectioncontext); break;
            
            case "PUT": this.processPUT(connectioncontext); break;
            
            case "DELETE": this.processDELETE(connectioncontext); break;
            
            case "TRACE": this.processTRACE(connectioncontext); break;
            
            case "OPTIONS": this.processOPTIONS(connectioncontext); break;
            
            case "CONNECT": this.processCONNECT(connectioncontext); break;
            
            case "PATCH": this.processPATCH(connectioncontext); break;
