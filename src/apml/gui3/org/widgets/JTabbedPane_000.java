...
public class JTabbedPane_000 extends JTabbedPane implements ChangeListener
{
	...
	{
		/*---------------------- tab items -------------------*/
		this.addTab("Tab 001", null, null, "Tab 001");

		this.addTab("Tab 002", null, null, "Tab 002");

		this.addTab("Tab 003", null, null, "Tab 003");
	...
	{
		return new Dimension(((int) (parent.getWidth() * 1.0) - this.marginleft), 50 - this.margintop);
	}
