...
import apml.xml.handlers.parser.models.apmltaghandler;
...
{    
    ...
    {        
        ...
        try
        {
            ...
            //
            for(int i=0; i<xparam.nodes1.getLength(); i++)
            {
                Node n = xparam.nodes1.item(i);
    ...
    public File[] renamefilesbyclass(File apmlfile, File sourcefile) throws Exception
    {
        ...
        try
        {
            ...
            File[] filenames = new File[xparam.nodes1.getLength()];      
            for(int i=0; i<xparam.nodes1.getLength(); i++)
            {
                Node n = xparam.nodes1.item(i);
    ...
    {        
        ...
        try
        {
            ...
            for(int i=0; i<xparam.nodes1.getLength(); i++)
            {
                Node node = xparam.nodes1.item(i);                
