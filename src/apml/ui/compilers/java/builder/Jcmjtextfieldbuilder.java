 ...
 * @author max rupplin
 */
public class Jcmjtextfieldbuilder
{
    public Jcmjtextfieldbuilder builder = this;
    ...
    public Jcmjtextfieldbuilder(File apml)
    {
        this.apml = apml;
    ...
    public ArrayList<JCodeModel> build(String tagname)
    {
        ...
        {        
            ...
            {            
                ...
                JDefinedClass jdefinedclass = jpackage._class("JTextField_"+String.format("%1$03d",i));     
                
                jdefinedclass._extends(JTextField.class);
