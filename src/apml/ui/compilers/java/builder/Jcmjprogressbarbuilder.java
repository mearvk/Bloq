 ...
 * @author max rupplin
 */
public class Jcmjprogressbarbuilder
{
    public Jcmjprogressbarbuilder builder = this;
    ...
    public ArrayList<JCodeModel> build(String tagname)
    {
        ...
        {        
            ...
            {            
                ...
                JDefinedClass jdefinedclass = jpackage._class("JProgressBar_"+String.format("%1$03d",i));     
                
                jdefinedclass._extends(JProgressBar.class);
