 ...
 * @author max rupplin
 */
public class Jcmjlayeredpanebuilder
{
    ...
    public ArrayList<JCodeModel> build(String tagname)
    {
        ...
        {        
            ...
            {            
                ...
                JDefinedClass jdefinedclass = jpackage._class("JLayeredPane_"+String.format("%1$03d",i));     
                
                jdefinedclass._extends(JLayeredPane.class);
