 ...
 * @author max rupplin
 */
public class Jcmjtooltipbuilder
{
    public Jcmjtooltipbuilder builder = this;
    ...
    public ArrayList<JCodeModel> build(String tagname)
    {
        ...
        {        
            ...
            {            
                ...
                JDefinedClass jdefinedclass = jpackage._class("JToolTip_"+String.format("%1$03d",i));     
                
                jdefinedclass._extends(JToolTip.class);
