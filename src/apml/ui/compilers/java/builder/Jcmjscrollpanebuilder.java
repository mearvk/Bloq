 ...
 * @author max rupplin
 */
public class Jcmjscrollpanebuilder
{
    ...
    public ArrayList<JCodeModel> build(String tagname)
    {
        ...
        {        
            ...
            {            
                ...
                JDefinedClass jdefinedclass = jpackage._class("JScrollPane_"+String.format("%1$03d",i));     
                
                jdefinedclass._extends(JScrollPane.class);
