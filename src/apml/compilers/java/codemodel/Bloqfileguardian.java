...
public class Bloqfileguardian
{
	...
	public String apmlinjarurl = "";                        //where project jar file is supposed to exist

	public String apmloutjarurl = "";                        //where project jar file is supposed to be written

	public String apmlinurl = "";                            //APML source file

	public String basedirurl = "";                            //where .xml or .events file would be

	public String loggingfileurl = "";                        //base logging URL for files

	//

	public String manifestfileurl = "manifest/";            //manifest URL for files
