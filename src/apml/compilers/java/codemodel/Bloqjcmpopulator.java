...
public class Bloqjcmpopulator
{
	...
	private JCodeModel makeindividualjcodemodelinstance(Apmlmodelfile apmlmodelfile) throws Exception
	{
		...
		try
		{
			...
			try
			{
				this.doapmlspecificbloqs(param);
			}
			catch (Exception e)
			{/*LOGGER.log(Level.WARNING, e.getMessage(), e);*/}
			...
			try
			{
				this.addjcminterfacemethods(param);
			}
			catch (Exception e)
			{/*LOGGER.log(Level.WARNING, e.getMessage(), e);*/}
			...
			try
			{
				this.addjcmsuperclassmethods(param);
			}
			catch (Exception e)
			{/*LOGGER.log(Level.WARNING, e.getMessage(), e);*/}
