...
public final class Apmlmodelpopulator 
{
    ...
    {
        try{logger.addHandler(new FileHandler("/home/oem/Desktop/apml/output/logging/Apmlmodelpopulator.txt"));}catch(Exception e){logger.log(Level.WARNING, e.getMessage(), e);}
    }
