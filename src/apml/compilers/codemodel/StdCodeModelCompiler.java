...
{       
    ...
    {   
        ...
        StdCodeModelCompiler test_compiler = new StdCodeModelCompiler(input_file);        
        ...
        try
        {                                                
            test_compiler.compile_source(input_file, output_file);
        }
        catch(Exception e)
        {
    ...
    public StdCodeModelCompiler(File file)
    {
        this.handler = new StdXmlHandler(file);
    }   

    public StdCodeModelCompiler(StdXmlHandler handler)
    {
    ...
    public void compile(StdXmlHandler xml_handler) throws Exception //
    {
