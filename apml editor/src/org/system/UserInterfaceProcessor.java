...
class LoadBodiTreeRequest
{
	...
	public void run()
	{
		...
		jtree_bodi_000.loadfromfile(event);
...
class LoadBloqTreeRequest
{
	...
	public void run()
	{
		...
		jtree_bloq_000.loadfromfile(event);
...
class LoadFalthruuTreeRequest
{
	...
	public void run()
	{
		...
		jtree_falthruu_000.loadfromfile(event);
...
class LoadMunctionTreeRequest
{
	...
	public void run()
	{
		...
		jtree_munction_000.loadfromfile(event);
...
class LoadRunynTreeRequest
{
	...
	public void run()
	{
		...
		jtree_runyn_000.loadfromfile(event);
...
class LoadSprungTreeRequest
{
	...
	public void run()
	{
		...
		jtree_sprung_000.loadfromfile(event);
...
class ReloadApmlTreeRequest
{
	...
	public void run()
	{
		...
		jtree_apml_000.loadfrombytes((ReloadApmlTreeEvent) event);
