 ...
 * @since
 */
public class ApmlBackboard extends JPanel
{

	public String bodi = "//editor/ui/apml_board";
	...
	public ApmlBackboard(Component parent)
	{
		// setters

		this.setBackground(new Color(0xef, 0xef, 0xef));
	...
	public ApmlBackboard(Component parent, Apmlbasesystem system)
	{
		// setters
