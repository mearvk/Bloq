...
public class JPanel_Tree_Sprung_000 extends JPanel
{
	...
	public JPanel_Tree_Sprung_000(Component parent)
	{
		...
		this.add(new JScrollpane_Tree_Sprung(jtree_000, parent));
...
class JScrollpane_Tree_Sprung extends JScrollPane
{
	public Component parent;

	public JTree jtree;

	public String bodi = "//editor/ui/sprung/jscrollpane";

	JScrollpane_Tree_Sprung(JTree jtree, Component parent)
	{
		//super
	...
	public Dimension getPreferredSize()
	{
		...
		int dividerlocation = sprung_backboard.jsplitpane_000.getDividerLocation();
