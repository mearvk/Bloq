...
public class JPanel_Tree_Munction_000 extends JPanel
{
	...
	public JPanel_Tree_Munction_000(Component parent)
	{
		...
		this.jtree_000 = new JTree_Munction_000(this);

		// hierarchy

		this.add(new JScrollpane_Tree_Munction(jtree_000, parent));
...
class JScrollpane_Tree_Munction extends JScrollPane
{
	public Component parent;

	public JTree jtree;

	public String bodi = "//editor/ui/munction/jscrollpane";

	JScrollpane_Tree_Munction(JTree jtree, Component parent)
	{
		//super
	...
	public Dimension getPreferredSize()
	{
		...
		int dividerlocation = munction_backboard.jsplitpane_000.getDividerLocation();
