...
import org.events.LoadSprungDocumentEvent;
 ...
 * @since
 */
public class JTree_Sprung_000 extends JTree
{
	...
	public void update(LoadSprungDocumentEvent event)
	{
		...
		try
		{
			...
			treenode = new DefaultMutableTreeNode("Sprung Projects", true);
