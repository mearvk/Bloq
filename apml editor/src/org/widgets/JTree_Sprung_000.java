 ...
 * @since
 */
public class JTree_Sprung_000 extends JTree_000
{
	public String bodi = "//editor/ui/jtree_sprung_000";
	 ...
	 */
	public JTree_Sprung_000(Component parent)
	{
		super(parent);
		...
		this.addTreeSelectionListener(new SprungJTreeOnClickListener(this));

		this.addMouseListener(new SprungJTreeOnClickListener(this));
	 ...
	 */
	public JTree_Sprung_000(Component parent, Apmlbasesystem system)
	{
		super(parent, system);
	...
	public void loadfromfile(LoadSprungTreeEvent event)
	{
