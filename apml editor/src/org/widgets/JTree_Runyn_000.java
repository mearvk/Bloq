 ...
 * @since
 */
public class JTree_Runyn_000 extends JTree
{
	public String bodi = "//editor/ui/jtree_runyn_000";
	 ...
	 */
	public JTree_Runyn_000(Component parent)
	{
		// setters
		...
		this.addTreeSelectionListener(new RunynJTreeOnClickListener(this));

		this.addMouseListener(new RunynJTreeOnClickListener(this));
	 ...
	 */
	public JTree_Runyn_000(Component parent, Apmlbasesystem system)
	{
		// setters
	...
	public void rloadfromnodelist(LoadRunynTreeEvent event)
	{
		...
		try
		{
			...
			RunynJTreeNode filenode = new RunynJTreeNode(file.getName(), file);
